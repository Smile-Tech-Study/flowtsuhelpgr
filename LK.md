...
Для граждан, прошедших обучение в 2025 году, доступен вход по ссылке <https://2025.lk.tgu-dpo.ru/>
...
![](./LK.png){width=2040px height=1200px}
...
Его гражданин подписывает последним  из участников-подписантов (сначала организация, реализующая программу и  работодатель (текущий или будущий)/ЦЗН и организация, реализующая программу - только для категории безработные граждане, зарегистрированные в ЦЗН). \
...
В первичные документы можно загрузить документ, подтверждающий трудоустройство. Для загрузки необходимо выбрать одну из форм занятости. Далее появится возможность добавить документ.

![](./LK.jpeg){width=1280px height=663px}
...
-  Заполните сведения о дипломе/документе об образовании.
   ...
   -  Если вы изменяли фамилию - включите настройку и приложите документ о смене фамилии, если  несколько раз меняли фамилию, приложите все документы.
...
-  ЦЗН - Образовательная организация - Гражданин (только для категории Безработные граждане, зарегистрированные в ЦЗН);
...
Вы можете приступить к обучению. Обучение ФО ТГУ будет проходить на платформе [Odin](https://www.odin.study/studentshelp).
